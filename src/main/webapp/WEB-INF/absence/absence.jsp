...
<jsp:useBean id="absences" type="java.util.HashMap<java.lang.Integer, iut2.brunetqu_projet_mi4.data.Absence[]>" scope="request"/>
...
<div>
  ...
  <%for(Absence absence : absences.get(etudiant.getId())){ %>
  <span><%= absence.isJustify() %></span>
  <%}%>
</div>
<%}%>
